          ...
          <div class="profile_data">
            ...
            <div @click="editMode.phoneNumber = true" class="editable-field">
              ...
              <UIInputField v-else @blur="handleFieldChange('phoneNumber')"
                            @keydown.enter="handleFieldChange('phoneNumber')" @keydown="restrictToNumbers"
                            v-model="local.phoneNumber" placeholder="Phone number" type="tel" inputmode="numeric"
                            :pattern="phoneNumberRegex" title="Please enter a valid phone number (e.g., +1 234-567-8901)" required />
            </div>
          </div>
        </div>

        <UIButtonStandard v-if="fieldChanged" :content="'Save changes'" />
      </form>
